...
$subject = "Order confirmation from SparklesANDShines";

$headers = "From:sparkles@ladiesfashionearrings.co.uk\n";
$headers.= "Reply-To <sparkles@ladiesfashionearrings.co.uk>\n";
...
if ($mailSent) {
	...
	echo "<p>Thank you for shopping with SparklesANDShines <br/>
